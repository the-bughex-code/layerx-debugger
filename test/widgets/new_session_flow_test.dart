...
/// route-transition (the overflow `PopupMenuButton`'s route, the confirm
/// bottom sheet) mid-composite: the animation clock advances past the end,
/// yet the last frame's layer tree isn't repainted, so hit-testing still
/// sees the route's barrier on top of the content. Stepping through smaller
/// frames lets each transition actually reach and paint its terminal frame.
